      ...
      <MapWrapper>
        ...
        {pendingCaptureZone && (
          <CaptureModalBackdrop>
            <CaptureModalCard>
              {/* Left Actions (Defender or Fail for Neutral) */}
              <CaptureModalSideActions className="left" isNeutral={captureState.isNeutral}>
                {captureState.isNeutral ? (
                  <CaptureButton
              ...
              {/* Right Actions (Attacker or Success for Neutral) */}
              <CaptureModalSideActions className="right" isNeutral={captureState.isNeutral}>
                {captureState.isNeutral ? (
                  <CaptureButton
